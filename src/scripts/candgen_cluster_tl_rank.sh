...
echo "evaluate"
python ./utils/evaluate_candgen.py --infile ${OUTDIR}/candgen.tab --edl_golden_file /pool0/webserver/incoming/experiment_tmp/EDL2019/data/gold/wikiname/${lang}_edl_wiki.tab
