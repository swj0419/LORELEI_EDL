...
from hma_translit.seq2seq.constants import EOS_token, SOS_ID, EOS_ID
from hma_translit.seq2seq.constants import SOS_token
from hma_translit.seq2seq.torch_utils import variable_from_sentence
